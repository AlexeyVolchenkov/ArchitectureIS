    ...
    if (charge > 0 && charge <= 100) {
        ...
        case Estate::Off:
            if (e.event == press_start1)
            {
                ...
                sys.press_start();
                cout << "ON - " << state << endl;
                cout << "Введите следующую команду\nВыключение робота - 2\nПерейти в состояние waiting - 3" << endl;
            }
            break;
        case Estate::On:
            if (e.event == waiting_command)
            {
                ...
                cout << "Введите следующую команду\nПерейти в состояние waiting - 3\nДвижение вперед - 4\nПоворот робота - 5\nНачать очистку - 6\nУстановка положения руки - 11"<<endl;
            }
        ...
        case Estate::waiting:
            ...
            else if (e.event == receive_turn)
            {
                state = Estate::turn_left;
                sys.rotating();
                cout << "Turn left  - " << state << endl;
                cout << "Выберите следующую команду\nПерейти в состояние waiting - 3\nДвижение вперед - 4\nНачать очистку - 6\nУстановка положения руки - 11";
            }
